<div class="container">
    ...
    <div class="form-group row">
        <label for="Nama Ruangan" class="col-sm-2 col-form-label">Nama Ruangan</label>
        <div class="col-sm-10">
            <input type="text" class="form-control" id="Nama Ruangan" placeholder="<?= $query->nama_ruangan; ?>" readonly>
        </div>
    </div>
    <div class="form-group row">
    ...
    <div class="col-sm-10 offset-sm-2">
        <div class="form-group">
            <div class="row">
                <form action="<?= base_url('admin/Peminjaman_prasarana/terima/' . $query->id_pinjam); ?>">
                    <button type="submit" class="btn btn-primary">Terima</button>
                </form>&nbsp;
                <form action="<?= base_url('admin/Peminjaman_prasarana/tolak/' . $query->id_pinjam); ?>">
